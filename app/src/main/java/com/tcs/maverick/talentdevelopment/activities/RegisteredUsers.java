 ...
 */
public class RegisteredUsers extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new DividerItemDecorator(RegisteredUsers.this, LinearLayoutManager.VERTICAL));
        onRefresh();
    ...
    public void getData() {
        ...
        String url = AppConstants.URL + "trainer_registered_members.php?emp_id=" + employeeId + "&session_id=" + courseId;

        HttpManager httpManager = new HttpManager(RegisteredUsers.this, new HttpManager.ServiceResponse() {
            @Override
